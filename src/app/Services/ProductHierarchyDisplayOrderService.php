...
final class ProductHierarchyDisplayOrderService
{
    ...
    /** @var array<string, array{model: class-string<Model>, table: string, parent: ?string, code: string, name: string, name_ar: string, child_relation: ?string}> */
    ...
    /** @param array{model: class-string<Model>, table: string, parent: ?string, code: string, name: string, name_ar: string, child_relation: ?string} $definition */
    ...
    /** @return array{model: class-string<Model>, table: string, parent: ?string, code: string, name: string, name_ar: string, child_relation: ?string} */
