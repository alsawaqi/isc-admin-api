   ...
   public function index(Request $request, Shipper $shipper)
    {
        $q = $shipper->destinations()->select(
            'id','Shippers_Id',
            'Shippers_Destination_Country','Shippers_Destination_Region','Shippers_Destination_District',
            'Shippers_Destination_Rate_Applicability',
            'Shippers_Destination_Country_Preference','Shippers_Destination_Region_Preference','Shippers_Destination_District_Preference',
            'created_at'
        );
