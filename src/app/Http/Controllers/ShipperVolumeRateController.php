    ...
    public function index(Request $request, ShipperDestination $destination)
    {
        $q = ShipperVolumeRate::query()
            ...
            ->select('id','Shippers_Id','Shippers_Destination_Id',
                'Shippers_Standard_Shipping_Volume_Size','Shippers_Standard_Shipping_Volume_Rate',
                'Shippers_Currency','Shippers_Min_Volume_Cbm','Shippers_Max_Volume_Cbm',
                'Shippers_Base_Fee','Shippers_Per_Cbm_Fee','Shippers_Flat_Fee','created_at');
